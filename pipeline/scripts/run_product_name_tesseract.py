...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tesseract-exe", type=Path, default=Path("A:/tesseract_env/Library/bin/tesseract.exe"))
    parser.add_argument("--tessdata-dir", type=Path, default=Path("A:/tesseract_env/Library/share/tessdata"))
